...
api_user = 'https://space.bilibili.com/{}/video?tid=0&page={}&keyword=&order=pubdate'


@contextmanager
def make_chrome_browser(executable_path=None):
    """
